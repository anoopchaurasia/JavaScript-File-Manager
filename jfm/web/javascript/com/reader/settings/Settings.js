...
com.reader.settings.Settings = function(base, me, Cookie, Container) {
	...
	this.Settings = function() {
		...
		var bgColor = Cookie.get("bgcolor"), color = Cookie.get("color");
		if (!bgColor) {
	...
	this.changeSettings = function(cb) {
		...
		html += "<tr><td>Background-Color:</td><td> <input id='background-color' class=' textinput colorwell' value=" + Cookie.get("bgcolor") + " /></td></tr>";
		html += "<tr><td>Color:</td> <td><input id='foreground-color' class='textinput colorwell' value=" + Cookie.get("color") + " /></td></tr>";
		html += "</table><div id='picker'></div></div>";
