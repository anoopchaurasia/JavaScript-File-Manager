...
facebook.Facebook = function() {
	...
	function getFingerprintForCookie (apiKey, cookies) {
	...
	this.Facebook = function(apiKey, apiSecret){
			/**
			 * Initialize extensions.
			 */
		  function fbSession(options) {
			...
			init : function(options) {
				...
				Request.include({
					...
					/**
					 * Find or create Facebook session based on stored session,
					 * GET params or cookie
					 * 
					 * @param {hash}
					 *            options
					 * @return {FBSession}
					...
					/**
					 * Try authenticating by verifying Facebook data in GET
					 * params and cookie
					 * 
					 * @param {hash}
					 *            options
					...
					fbAuthenticate : function(options) {
						...
						if (cookies && cookies[apiKey]) {
							fingerprint = getFingerprintForCookie(apiKey, cookies);
